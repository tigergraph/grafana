...
require (
	...
	golang.org/x/crypto v0.25.0 // @grafana/backend-platform
	...
	google.golang.org/api v0.191.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20240730163845-b1a4ccb954bf // indirect; @grafana/backend-platform
)
