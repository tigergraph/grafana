...
require (
	...
	github.com/grafana/grafana-azure-sdk-go/v2 v2.1.4 // @grafana/partner-datasources
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/azidentity v1.8.0 // @grafana/backend-platform
