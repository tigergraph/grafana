...
require (
	...
	golang.org/x/time v0.6.0 // @grafana/backend-platform
	...
	google.golang.org/api v0.196.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20240903143218-8af14fe29dc1 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.19.0 // @grafana/backend-platform
