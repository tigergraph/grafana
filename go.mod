...
require (
	cloud.google.com/go/storage v1.50.0 // @grafana/backend-platform
	...
	github.com/golang/mock v1.7.0-rc.1 // @grafana/alerting-squad-backend
	...
	github.com/grafana/grafana-plugin-sdk-go v0.220.0 // @grafana/plugins-platform-backend
	...
	github.com/prometheus/common v0.67.5 // @grafana/alerting-squad-backend
	...
	golang.org/x/exp v0.0.0-20251219203646-944ab1f22d93 // @grafana/alerting-squad-backend
	...
	google.golang.org/api v0.228.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20250324211829-b45e905df463 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.21.0 // @grafana/backend-platform
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.40.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.40.0 // @grafana/backend-platform
...
require k8s.io/code-generator v0.36.3 // @grafana/grafana-app-platform-squad
