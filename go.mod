...
require (
	...
	go.opentelemetry.io/otel/sdk v1.25.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.25.0 // @grafana/backend-platform
	...
	google.golang.org/grpc v1.63.0 // @grafana/plugins-platform-backend
...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.25.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.25.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.25.0 // @grafana/backend-platform
