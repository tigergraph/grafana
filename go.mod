...
require (
	...
	golang.org/x/exp v0.0.0-20241009180824-f66d83c29e7c // @grafana/alerting-squad-backend
...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.43.0 // @grafana/backend-platform
