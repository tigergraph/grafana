...
require (
	...
	github.com/prometheus/common v0.54.0 // @grafana/alerting-squad-backend
...
require github.com/grafana/pyroscope-go/godeltaprof v0.1.7 // @grafana/observability-traces-and-profiling
