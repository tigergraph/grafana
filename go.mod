...
require (
	...
	google.golang.org/api v0.195.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20240823204242-4ba0660f739c // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.18.5 // @grafana/backend-platform
