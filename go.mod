...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/azidentity v1.8.1 // @grafana/backend-platform
...
require github.com/getkin/kin-openapi v0.128.0 // @grafana/grafana-as-code
