...
require (
	...
	go.opentelemetry.io/otel/sdk v1.26.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.26.0 // @grafana/backend-platform
	golang.org/x/crypto v0.24.0 // @grafana/backend-platform
	golang.org/x/exp v0.0.0-20240416160154-fe59bbe5cc7f // @grafana/alerting-squad-backend
...
require (
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.26.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.26.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.26.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.20.0 // @grafana/backend-platform
...
require github.com/grafana/grafana/pkg/promlib v0.0.6 // @grafana/observability-metrics
