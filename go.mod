...
require (
	...
	google.golang.org/api v0.200.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20241007155032-5fefd90f89a9 // indirect; @grafana/backend-platform
)
