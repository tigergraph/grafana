...
require (
	...
	google.golang.org/api v0.203.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20241015192408-796eee8c2d53 // indirect; @grafana/backend-platform
)
